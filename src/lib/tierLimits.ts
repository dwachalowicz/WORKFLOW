...
const FALLBACK_CONFIG: Record<UserTier, TierConfig> = {
  FREE: {
    ...
    aiAccess: 'none', aiMemoryLength: 10,
  ...
  MEDIUM: {
    ...
    sortOrder: 1,
    maxWorkspaces: 3, maxVersionsPerProcess: 25, maxProcesses: 50,
    maxNodesPerProcess: 100, maxEdgesPerProcess: 150, maxNotesPerProcess: 20,
    maxMembersPerWorkspace: 10, maxGroupsPerWorkspace: 10,
  ...
  PRO: {
    ...
    sortOrder: 2,
    maxWorkspaces: 10, maxVersionsPerProcess: 100, maxProcesses: 500,
    maxNodesPerProcess: Infinity, maxEdgesPerProcess: Infinity, maxNotesPerProcess: Infinity,
    maxMembersPerWorkspace: 50, maxGroupsPerWorkspace: Infinity,
